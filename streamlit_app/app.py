...
def main():
    ...
    if uploaded_file is not None:
        ...
        segmented_path = os.path.join('data/output', 'segmented_image.png')
        ...
        mapped_data_path = os.path.join('data/output', 'mapped_data.json')
        with open(mapped_data_path, 'w') as f:
            json.dump(mapped_data, f, indent=4)

        st.write("Generating output...")
        final_image_path = os.path.join('data/output', 'final_image.png')
